...
function SelectionDot(_ref) {
  ...
  const circleRadius = (0, _reactNativeSkia.useValue)(0);
  const circleStrokeRadius = (0, _reactNativeSkia.useComputedValue)(() => circleRadius.current * CIRCLE_RADIUS_MULTIPLIER, [circleRadius]);
  const setIsActive = (0, _react.useCallback)(active => {
    (0, _reactNativeSkia.runSpring)(circleRadius, active ? CIRCLE_RADIUS : 0, {
      mass: 1,
      stiffness: 1000,
      damping: 50,
      velocity: 0
